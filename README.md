...
> Algo como o seguinte 'git@github.com:theuspm/seu-barriga.git'

2. Após o clone do projeto, acesse o diretório recém clonado (ex.: `cd seu-barriga/`).
...
# Instalação de dependencias do mochawesome
1. Na raiz do projeto, execute o comando `npm install --save-dev cypress-mochawesome-reporter mochawesome mochawesome-merge`
2. No No arquivo cypress/support/e2e.js, adicione: `import 'cypress-mochawesome-reporter/register';`
3. Verifique tambem a configuração correta no arquivo cypress.config.js
4. Para obter relatórios execute `npx cypress run`. O relatório estará em `cypress/reports/html/index.html`
